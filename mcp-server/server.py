        ...
        try:
            ...
            return [
                TextContent(
                    type="text",
                    text=(
                        f"Successfully saved '{word_data['word']}' to your vocabulary deck. "
                        f"It will be due for review on {word_data['next_review']}."
                    ),
                )
            ]
            ...
            return [
                TextContent(
                    type="text",
                    text=f"Failed to save word: HTTP {e.response.status_code} — {e.response.text}",
                )
            ]
