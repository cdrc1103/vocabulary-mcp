...
class TestApplySM2PassingQuality:
    ...
    def test_quality_5_increases_ease(self):
        """Test perfect quality (5) increases ease factor by 0.1."""
    ...
    def test_quality_3_decreases_ease(self):
        """Test minimum passing quality (3) decreases ease factor."""
    ...
    def test_ease_factor_floor_at_1_3(self):
        """Test ease factor never goes below minimum of 1.3."""
